...
public class SearchInContextTest {
    ...
    public void forClassesToCheck_method_inB(){
        ...
        Set<String> classesToCheck = searchInContext.getClassesToCheckForMethod((MethodDecl)searchInContext.targetAstNode());
    ...
    public void forClassesToCheck_field_inE(){
        ...
        SearchInContext searchInContext = new SearchInContext(prog, false, oldName, lineNumber);
        Set<String> classesToCheck = searchInContext.getClassesToCheckForField((VarDecl) searchInContext.targetAstNode());
        Set<String> expected = new HashSet<>();
        expected.add("A");
        expected.add("B");
        expected.add("C");
