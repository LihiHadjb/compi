...
define i32 @TV.Start(i8* %this){
	...
	%_5 = load i8**, i8*** %_4
	%_6 = getelementptr i8*, i8** %_5, i32 12
	%_7 = load i8*, i8** %_6
	...
	%_12 = load i8**, i8*** %_11
	%_13 = getelementptr i8*, i8** %_12, i32 11
	%_14 = load i8*, i8** %_13
	...
	%_26 = load i8**, i8*** %_25
	%_27 = getelementptr i8*, i8** %_26, i32 9
	%_28 = load i8*, i8** %_27
	...
	%_40 = load i8**, i8*** %_39
	%_41 = getelementptr i8*, i8** %_40, i32 9
	%_42 = load i8*, i8** %_41
	...
	%_68 = load i8**, i8*** %_67
	%_69 = getelementptr i8*, i8** %_68, i32 11
	%_70 = load i8*, i8** %_69
	...
	%_78 = load i8**, i8*** %_77
	%_79 = getelementptr i8*, i8** %_78, i32 10
	%_80 = load i8*, i8** %_79
	...
	%_93 = load i8**, i8*** %_92
	%_94 = getelementptr i8*, i8** %_93, i32 16
	%_95 = load i8*, i8** %_94
	...
	%_100 = load i8**, i8*** %_99
	%_101 = getelementptr i8*, i8** %_100, i32 16
	...
	%_115 = getelementptr i8*, i8** %_114, i32 16
	...
	%_122 = getelementptr i8*, i8** %_121, i32 0
	...
	%_129 = getelementptr i8*, i8** %_128, i32 11
...
define i1 @Tree.Init(i8* %this, i32 %.v_key){
	...
	%_1 = getelementptr i8, i8* %this, i32 34
	%_2 = bitcast i8* %_1 to i32*
	store i32 %_0, i32* %_2
	%_3 = getelementptr i8, i8* %this, i32 33
...
define i1 @Tree.SetRight(i8* %this, i8* %.rn){
	...
	store i8* %.rn, i8** %rn
	%_0 = load i8*, i8** %rn
	%_1 = getelementptr i8, i8* %this, i32 25
...
define i8* @Tree.GetRight(i8* %this){
	%_0 = getelementptr i8, i8* %this, i32 25
	%_1 = bitcast i8* %_0 to i8**
	%_2 = load i8*, i8** %_1
	ret i8* %_2
}
...
define i32 @Tree.GetKey(i8* %this){
	%_0 = getelementptr i8, i8* %this, i32 34
...
define i1 @Tree.GetHas_Left(i8* %this){
	%_0 = getelementptr i8, i8* %this, i32 33
	%_1 = bitcast i8* %_0 to i1*
	%_2 = load i1, i1* %_1
	ret i1 %_2
}
...
define i1 @Tree.SetHas_Left(i8* %this, i1 %.val){
	...
	store i1 %.val, i1* %val
	%_0 = load i1, i1* %val
	%_1 = getelementptr i8, i8* %this, i32 33
...
if6:
	...
	%_24 = load i8**, i8*** %_23
	%_25 = getelementptr i8*, i8** %_24, i32 14
	%_26 = load i8*, i8** %_25
...
if9:
	...
	%_31 = load i8**, i8*** %_30
	%_32 = getelementptr i8*, i8** %_31, i32 5
	%_33 = load i8*, i8** %_32
...
if7:
	...
	%_53 = load i8**, i8*** %_52
	%_54 = getelementptr i8*, i8** %_53, i32 13
	%_55 = load i8*, i8** %_54
...
if12:
	...
	%_60 = load i8**, i8*** %_59
	%_61 = getelementptr i8*, i8** %_60, i32 6
	%_62 = load i8*, i8** %_61
...
if13:
	...
	%_67 = load i8**, i8*** %_66
	%_68 = getelementptr i8*, i8** %_67, i32 19
	%_69 = load i8*, i8** %_68
...
if15:
	...
	%_13 = load i8**, i8*** %_12
	%_14 = getelementptr i8*, i8** %_13, i32 14
	%_15 = load i8*, i8** %_14
...
if21:
	...
	%_30 = bitcast i8* %_29 to i8***
	%_31 = load i8**, i8*** %_30
	%_32 = getelementptr i8*, i8** %_31, i32 13
	%_33 = load i8*, i8** %_32
...
if24:
	...
	%_39 = load i8**, i8*** %_38
	%_40 = getelementptr i8*, i8** %_39, i32 6
	%_41 = load i8*, i8** %_40
...
if27:
	...
	%_46 = bitcast i8* %_45 to i8***
	%_47 = load i8**, i8*** %_46
	%_48 = getelementptr i8*, i8** %_47, i32 13
	%_49 = load i8*, i8** %_48
	...
	br label %andcond0
andcond0:
	br i1 %_52, label %andcond1, label %andcond3
andcond1:
	%_53 = load i8*, i8** %current_node
	%_54 = bitcast i8* %_53 to i8***
	%_55 = load i8**, i8*** %_54
	%_56 = getelementptr i8*, i8** %_55, i32 14
	%_57 = load i8*, i8** %_56
...
andcond2:
	br label %andcond3
andcond3:
	%_61 = phi i1 [0, %andcond0], [%_60, %andcond2]
...
if31:
	...
	%_63 = load i8**, i8*** %_62
	%_64 = getelementptr i8*, i8** %_63, i32 7
	%_65 = load i8*, i8** %_64
...
define i1 @Tree.Remove(i8* %this, i8* %.p_node, i8* %.c_node){
	...
	%_1 = bitcast i8* %_0 to i8***
	%_2 = load i8**, i8*** %_1
	%_3 = getelementptr i8*, i8** %_2, i32 14
	%_4 = load i8*, i8** %_3
...
if34:
	...
	%_17 = load i8**, i8*** %_16
	%_18 = getelementptr i8*, i8** %_17, i32 13
	%_19 = load i8*, i8** %_18
...
if37:
	...
	%_52 = load i8**, i8*** %_51
	%_53 = getelementptr i8*, i8** %_52, i32 18
	%_54 = load i8*, i8** %_53
	...
	br i1 %_58, label %if39, label %if40
if39:
	...
	%_65 = getelementptr i8, i8* %this, i32 17
	%_66 = bitcast i8* %_65 to i8**
	%_67 = load i8*, i8** %_66
...
if40:
	...
	%_82 = getelementptr i8, i8* %this, i32 17
	...
	%_88 = load i8**, i8*** %_87
	%_89 = getelementptr i8*, i8** %_88, i32 19
	%_90 = load i8*, i8** %_89
...
loop6:
	...
	%_1 = bitcast i8* %_0 to i8***
	%_2 = load i8**, i8*** %_1
	%_3 = getelementptr i8*, i8** %_2, i32 13
	%_4 = load i8*, i8** %_3
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
...
loop7:
	...
	%_16 = load i8**, i8*** %_15
	%_17 = getelementptr i8*, i8** %_16, i32 17
	%_18 = load i8*, i8** %_17
...
loop8:
	...
	%_42 = getelementptr i8, i8* %this, i32 17
	...
	%_48 = load i8**, i8*** %_47
	%_49 = getelementptr i8*, i8** %_48, i32 19
	%_50 = load i8*, i8** %_49
...
loop10:
	...
	%_8 = bitcast i8* %_7 to i8***
	%_9 = load i8**, i8*** %_8
	%_10 = getelementptr i8*, i8** %_9, i32 5
	%_11 = load i8*, i8** %_10
	%_12 = bitcast i8* %_11 to i8* (i8*)*
	%_13 = call i8* %_12(i8* %_7)
	store i8* %_13, i8** %t
...
if48:
	...
	%_30 = load i8**, i8*** %_29
	%_31 = getelementptr i8*, i8** %_30, i32 13
	%_32 = load i8*, i8** %_31
...
if51:
	...
	%_37 = load i8**, i8*** %_36
	%_38 = getelementptr i8*, i8** %_37, i32 6
	%_39 = load i8*, i8** %_38
...
define i1 @Tree.Print(i8* %this){
	...
	%_1 = load i8**, i8*** %_0
	%_2 = getelementptr i8*, i8** %_1, i32 20
	%_3 = load i8*, i8** %_2
...
if54:
	%_7 = bitcast i8* %this to i8***
	%_8 = load i8**, i8*** %_7
	%_9 = getelementptr i8*, i8** %_8, i32 20
	%_10 = load i8*, i8** %_9
...
if56:
	...
	%_29 = load i8**, i8*** %_28
	%_30 = getelementptr i8*, i8** %_29, i32 13
	%_31 = load i8*, i8** %_30
...
if57:
	...
	%_35 = load i8**, i8*** %_34
	%_36 = getelementptr i8*, i8** %_35, i32 20
	%_37 = load i8*, i8** %_36
...
if60:
	...
	%_19 = bitcast i8* %_18 to i8***
	%_20 = load i8**, i8*** %_19
	%_21 = getelementptr i8*, i8** %_20, i32 10
	%_22 = load i8*, i8** %_21
...
if62:
	...
	%_27 = load i8**, i8*** %_26
	%_28 = getelementptr i8*, i8** %_27, i32 14
	%_29 = load i8*, i8** %_28
...
if63:
	...
	%_39 = getelementptr i8, i8* %this, i32 16
	%_40 = bitcast i8* %_39 to i8**
	store i8* %_38, i8** %_40
	%_41 = getelementptr i8, i8* %this, i32 16
	%_42 = bitcast i8* %_41 to i8**
	%_43 = load i8*, i8** %_42
	%_44 = bitcast i8* %_43 to i8***
	%_45 = load i8**, i8*** %_44
	%_46 = getelementptr i8*, i8** %_45, i32 10
	%_47 = load i8*, i8** %_46
...
if68:
	...
	%_33 = bitcast i8* %_32 to i8***
	%_34 = load i8**, i8*** %_33
	%_35 = getelementptr i8*, i8** %_34, i32 14
	%_36 = load i8*, i8** %_35
...
if69:
	...
	%_52 = load i8**, i8*** %_51
	%_53 = getelementptr i8*, i8** %_52, i32 10
	%_54 = load i8*, i8** %_53
