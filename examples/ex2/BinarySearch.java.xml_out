...
if8:
	...
	%_32 = load i8**, i8*** %_31
	%_33 = getelementptr i8*, i8** %_32, i32 4
	%_34 = load i8*, i8** %_33
...
if17:
	...
	%_50 = load i8**, i8*** %_49
	%_51 = getelementptr i8*, i8** %_50, i32 4
	%_52 = load i8*, i8** %_51
...
if20:
	...
	%_56 = load i8**, i8*** %_55
	%_57 = getelementptr i8*, i8** %_56, i32 4
	%_58 = load i8*, i8** %_57
...
loop1:
	...
	br i1 %_21, label %arr_alloc0, label %arr_alloc1
arr_alloc0:
	call void @throw_oob()
	br label %arr_alloc1
arr_alloc1:
	...
	br i1 %_24, label %arr_alloc2, label %arr_alloc3
arr_alloc2:
	call void @throw_oob()
	br label %arr_alloc3
arr_alloc3:
	...
	br i1 %_30, label %if24, label %if25
if24:
...
if26:
	...
	br i1 %_42, label %if27, label %if28
if27:
...
if29:
	...
	br i1 %_45, label %if30, label %if31
if30:
	store i1 0, i1* %var_cont
	br label %if32
if31:
...
define i1 @BS.Compare(i8* %this, i32 %.num1, i32 %.num2){
	...
	%_4 = icmp slt i32 %_2, %_3
	br i1 %_4, label %if36, label %if37
if36:
	store i1 0, i1* %retval
	br label %if38
if37:
	...
	%_8 = sub i1 1, %_7
	br i1 %_8, label %if39, label %if40
if39:
	store i1 0, i1* %retval
	br label %if41
if40:
...
loop7:
	...
	br i1 %_9, label %arr_alloc4, label %arr_alloc5
arr_alloc4:
	call void @throw_oob()
	br label %arr_alloc5
arr_alloc5:
...
define i32 @BS.Init(i8* %this, i32 %.sz){
	...
	br i1 %_4, label %arr_alloc8, label %arr_alloc9
arr_alloc8:
	call void @throw_oob()
	br label %arr_alloc9
arr_alloc9:
...
loop9:
	...
	br i1 %_18, label %loop10, label %loop11
loop10:
	%_19 = load i32, i32* %j
	%_20 = mul i32 2, %_19
