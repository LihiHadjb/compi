...
loop4:
	...
	br i1 %_18, label %arr_alloc0, label %arr_alloc1
arr_alloc0:
	call void @throw_oob()
	br label %arr_alloc1
arr_alloc1:
	...
	br i1 %_21, label %arr_alloc2, label %arr_alloc3
arr_alloc2:
	call void @throw_oob()
	br label %arr_alloc3
arr_alloc3:
	...
	br i1 %_29, label %arr_alloc4, label %arr_alloc5
arr_alloc4:
	call void @throw_oob()
	br label %arr_alloc5
arr_alloc5:
	...
	br i1 %_32, label %arr_alloc6, label %arr_alloc7
arr_alloc6:
	call void @throw_oob()
	br label %arr_alloc7
arr_alloc7:
...
if0:
	...
	br i1 %_45, label %arr_alloc8, label %arr_alloc9
arr_alloc8:
	call void @throw_oob()
	br label %arr_alloc9
arr_alloc9:
	...
	br i1 %_48, label %arr_alloc10, label %arr_alloc11
arr_alloc10:
	call void @throw_oob()
...
arr_alloc11:
	...
	%_56 = icmp slt i32 %_55, 0
	br i1 %_56, label %arr_alloc12, label %arr_alloc13
arr_alloc12:
	call void @throw_oob()
	br label %arr_alloc13
arr_alloc13:
	%_57 = getelementptr i32, i32* %_54, i32 0
	%_58 = load i32, i32* %_57
	%_59 = icmp sle i32 %_58, %_55
	br i1 %_59, label %arr_alloc14, label %arr_alloc15
arr_alloc14:
	call void @throw_oob()
...
arr_alloc15:
	...
	%_65 = load i32, i32* %j
	%_66 = icmp slt i32 %_65, 0
	br i1 %_66, label %arr_alloc16, label %arr_alloc17
arr_alloc16:
	call void @throw_oob()
	br label %arr_alloc17
arr_alloc17:
	%_67 = getelementptr i32, i32* %_64, i32 0
	%_68 = load i32, i32* %_67
	%_69 = icmp sle i32 %_68, %_65
	br i1 %_69, label %arr_alloc18, label %arr_alloc19
arr_alloc18:
	call void @throw_oob()
...
arr_alloc19:
	...
	%_76 = load i32, i32* %j
	%_77 = icmp slt i32 %_76, 0
	br i1 %_77, label %arr_alloc20, label %arr_alloc21
arr_alloc20:
	call void @throw_oob()
	br label %arr_alloc21
arr_alloc21:
	%_78 = getelementptr i32, i32* %_75, i32 0
	%_79 = load i32, i32* %_78
	%_80 = icmp sle i32 %_79, %_76
	br i1 %_80, label %arr_alloc22, label %arr_alloc23
arr_alloc22:
	call void @throw_oob()
	br label %arr_alloc23
arr_alloc23:
	%_81 = add i32 %_76, 1
	%_82 = getelementptr i32, i32* %_75, i32 %_81
	%_83 = load i32, i32* %t
...
loop7:
	...
	br i1 %_9, label %arr_alloc24, label %arr_alloc25
arr_alloc24:
	call void @throw_oob()
...
arr_alloc25:
	...
	br i1 %_12, label %arr_alloc26, label %arr_alloc27
arr_alloc26:
	call void @throw_oob()
...
define i32 @BBS.Init(i8* %this, i32 %.sz){
	...
	br i1 %_4, label %arr_alloc28, label %arr_alloc29
arr_alloc28:
	call void @throw_oob()
...
arr_alloc29:
	...
	br i1 %_13, label %arr_alloc30, label %arr_alloc31
arr_alloc30:
	call void @throw_oob()
...
arr_alloc31:
	...
	br i1 %_16, label %arr_alloc32, label %arr_alloc33
arr_alloc32:
	call void @throw_oob()
...
arr_alloc33:
	...
	br i1 %_22, label %arr_alloc34, label %arr_alloc35
arr_alloc34:
	call void @throw_oob()
...
arr_alloc35:
	...
	br i1 %_25, label %arr_alloc36, label %arr_alloc37
arr_alloc36:
	call void @throw_oob()
...
arr_alloc37:
	...
	br i1 %_31, label %arr_alloc38, label %arr_alloc39
arr_alloc38:
	call void @throw_oob()
...
arr_alloc39:
	...
	br i1 %_34, label %arr_alloc40, label %arr_alloc41
arr_alloc40:
	call void @throw_oob()
...
arr_alloc41:
	...
	br i1 %_40, label %arr_alloc42, label %arr_alloc43
arr_alloc42:
	call void @throw_oob()
...
arr_alloc43:
	...
	br i1 %_43, label %arr_alloc44, label %arr_alloc45
arr_alloc44:
	call void @throw_oob()
...
arr_alloc45:
	...
	br i1 %_49, label %arr_alloc46, label %arr_alloc47
arr_alloc46:
	call void @throw_oob()
...
arr_alloc47:
	...
	br i1 %_52, label %arr_alloc48, label %arr_alloc49
arr_alloc48:
	call void @throw_oob()
...
arr_alloc49:
	...
	br i1 %_58, label %arr_alloc50, label %arr_alloc51
arr_alloc50:
	call void @throw_oob()
...
arr_alloc51:
	...
	br i1 %_61, label %arr_alloc52, label %arr_alloc53
arr_alloc52:
	call void @throw_oob()
...
arr_alloc53:
	...
	br i1 %_67, label %arr_alloc54, label %arr_alloc55
arr_alloc54:
	call void @throw_oob()
...
arr_alloc55:
	...
	br i1 %_70, label %arr_alloc56, label %arr_alloc57
arr_alloc56:
	call void @throw_oob()
...
arr_alloc57:
	...
	br i1 %_76, label %arr_alloc58, label %arr_alloc59
arr_alloc58:
	call void @throw_oob()
...
arr_alloc59:
	...
	br i1 %_79, label %arr_alloc60, label %arr_alloc61
arr_alloc60:
	call void @throw_oob()
...
arr_alloc61:
	...
	br i1 %_85, label %arr_alloc62, label %arr_alloc63
arr_alloc62:
	call void @throw_oob()
...
arr_alloc63:
	...
	br i1 %_88, label %arr_alloc64, label %arr_alloc65
arr_alloc64:
	call void @throw_oob()
...
arr_alloc65:
	...
	br i1 %_94, label %arr_alloc66, label %arr_alloc67
arr_alloc66:
	call void @throw_oob()
...
arr_alloc67:
	...
	br i1 %_97, label %arr_alloc68, label %arr_alloc69
arr_alloc68:
	call void @throw_oob()
