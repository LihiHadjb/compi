...
define i32 @BT.Start(i8* %this){
	...
	%_5 = load i8**, i8*** %_4
	%_6 = getelementptr i8*, i8** %_5, i32 11
	%_7 = load i8*, i8** %_6
	...
	%_12 = load i8**, i8*** %_11
	%_13 = getelementptr i8*, i8** %_12, i32 10
	%_14 = load i8*, i8** %_13
	...
	%_26 = load i8**, i8*** %_25
	%_27 = getelementptr i8*, i8** %_26, i32 10
	%_28 = load i8*, i8** %_27
	...
	%_68 = load i8**, i8*** %_67
	%_69 = getelementptr i8*, i8** %_68, i32 9
	%_70 = load i8*, i8** %_69
	...
	%_75 = load i8**, i8*** %_74
	%_76 = getelementptr i8*, i8** %_75, i32 10
	%_77 = load i8*, i8** %_76
	...
	%_82 = load i8**, i8*** %_81
	%_83 = getelementptr i8*, i8** %_82, i32 15
	%_84 = load i8*, i8** %_83
	...
	%_89 = load i8**, i8*** %_88
	%_90 = getelementptr i8*, i8** %_89, i32 15
	%_91 = load i8*, i8** %_90
	...
	%_96 = load i8**, i8*** %_95
	%_97 = getelementptr i8*, i8** %_96, i32 15
	%_98 = load i8*, i8** %_97
	...
	%_104 = getelementptr i8*, i8** %_103, i32 15
	...
	%_111 = getelementptr i8*, i8** %_110, i32 15
	...
	%_118 = getelementptr i8*, i8** %_117, i32 0
	...
	%_125 = getelementptr i8*, i8** %_124, i32 10
	...
	%_132 = getelementptr i8*, i8** %_131, i32 15
...
if0:
	...
	%_24 = load i8**, i8*** %_23
	%_25 = getelementptr i8*, i8** %_24, i32 13
	%_26 = load i8*, i8** %_25
...
if7:
	...
	%_67 = load i8**, i8*** %_66
	%_68 = getelementptr i8*, i8** %_67, i32 18
	%_69 = load i8*, i8** %_68
...
define i1 @Tree.Delete(i8* %this, i32 %.v_key){
	...
	%key_aux = alloca i32
	%ntb = alloca i1
	store i8* %_-1, i8** %current_node
	store i8* %_-1, i8** %parent_node
	store i1 1, i1* %cont
	store i1 0, i1* %found
...
if0:
	...
	%_13 = load i8**, i8*** %_12
	%_14 = getelementptr i8*, i8** %_13, i32 13
	%_15 = load i8*, i8** %_14
...
if6:
	...
	br i1 %_35, label %if9, label %if10
if9:
	%_36 = load i8*, i8** %current_node
...
andcond1:
	...
	%_55 = load i8**, i8*** %_54
	%_56 = getelementptr i8*, i8** %_55, i32 13
	%_57 = load i8*, i8** %_56
...
andcond3:
	...
	br i1 %_61, label %if15, label %if16
if15:
	store i1 1, i1* %ntb
	br label %if17
if16:
...
if1:
	...
	%_17 = load i8**, i8*** %_16
	%_18 = getelementptr i8*, i8** %_17, i32 12
	%_19 = load i8*, i8** %_18
...
if3:
	...
	%_23 = load i8**, i8*** %_22
	%_24 = getelementptr i8*, i8** %_23, i32 14
	%_25 = load i8*, i8** %_24
...
if7:
	...
	%_88 = load i8**, i8*** %_87
	%_89 = getelementptr i8*, i8** %_88, i32 18
	%_90 = load i8*, i8** %_89
...
loop0:
	...
	%_1 = bitcast i8* %_0 to i8***
	%_2 = load i8**, i8*** %_1
	%_3 = getelementptr i8*, i8** %_2, i32 12
	%_4 = load i8*, i8** %_3
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
...
loop2:
	...
	%_48 = load i8**, i8*** %_47
	%_49 = getelementptr i8*, i8** %_48, i32 18
	%_50 = load i8*, i8** %_49
...
if6:
	...
	br i1 %_34, label %if9, label %if10
if9:
